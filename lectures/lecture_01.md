...
- 1.10 Τι είναι οι μεταβλητές
- 1.11 Στοιχεία μεταβλητής
- 1.12 Εκχώρηση τιμής
- 1.13 Σχόλια
...
Μία εντολή εκχώρησης αποτελείται από τρία μέρη: το αριστερό που υποχρεωτικά πρέπει να είναι το όνομα της μεταβλητής, το ίσον = (τελεστής εκχώρησης) και το δεξί μέρος που μπορεί να είναι μία τιμή ή μία άλλη μεταβλητή.
