...
```python
print(2 * (4 - 1)) # Apotelesma -> 6
print(2 * 4 - 1) # Apotelesma -> 7
print((2 + 1) ** (5 - 2)) # Apotelesma -> 27
print(2 ** 1 + 1) # Apotelesma -> 3
print(2 ** (1 + 1)) # Apotelesma -> 4
```
...
```python
print(3 * 5 + 2) # Apotelesma -> 17
print(15 / 3 - 2) # Apotelesma -> 3.0
```
