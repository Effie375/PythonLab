...
Αρχικά ζητάμε από τον υπάλληλο να εισάγει το όνομά του. Μετά του ζητάμε να μας δώσει τον αρχικό μισθό (Α.Μ) που παίρνει και τον ποσοστό φόρου (Π.Φ) που πληρώνει. Στην συνέχεια υπολογίζουμε τον τελικό μισθό (Τ.Μ) του ο οποίος προκύπτει απο τον εξής τύπο `Α.Μ - (Α.Μ * Π.Φ * %)`. Τέλος εκτυπώνουμε στην οθόνη το όνομά και τον τελικό μισθό του.
