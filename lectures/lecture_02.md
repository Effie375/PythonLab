...
- Μετά του ζητάμε να μας δώσει τον αρχικό μισθό (Α.Μ) που παίρνει και το ποσοστό φόρου (Π.Φ) που πληρώνει.
- Στην συνέχεια υπολογίζουμε τον τελικό μισθό (Τ.Μ) ο οποίος προκύπτει απο τον τύπο `αρχικός μισθός - (αρχικός μισθός * ποσοστό φόρου * %)`.
