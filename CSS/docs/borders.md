...
Για να συντομεύσετε τον κώδικα, είναι επίσης δυνατό να καθορίσετε όλες τις μεμονωμένες ιδιότητες περιγράμματος σε μία ιδιότητα. Δηλαδή όλες οι ιδιότητες να φαίνοντα σα μια ιδιότητα και να μπουν οι αντιστοιχές τιμές, όπως στο παρακάτω παράδειγμα.
